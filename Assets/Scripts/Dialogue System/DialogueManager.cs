...
public class DialogueManager : MonoBehaviour
{
    ...
    public Image characterPortrait;  // 캐릭터 초상화 (선택사항)

    [Header("음성 설정")]
    public AudioSource audioSource;

    [Header("구두점 음성 (고정)")]
    public AudioClip dotSound;          // 마침표(.), 쉼표(,) 소리
    public AudioClip questionSound;     // 물음표(?) 소리
    public AudioClip exclamationSound;  // 느낌표(!) 소리
    public AudioClip defaultPuncSound;  // 기타 구두점 소리
